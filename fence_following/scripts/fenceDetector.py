...
class FenceDetector:
    ...
    def on_new_msg(
        ...
        fence_pcl, ground_pcl = self.segment_fence_pcl(pcl)
    ...
    def visualize_segmentation(
        ...
        plt.scatter(pcl[:,0],pcl[:,1],color='green',label="Removed points")
        plt.scatter(pcl_fence[:,0],pcl_fence[:,1],color='red',label="Fence points")
        plt.scatter(pcl_ground[:,0],pcl_ground[:,1],color='black',label="Ground points")
